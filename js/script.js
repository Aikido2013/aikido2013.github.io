...
$(document).ready(function(){
	...
	$.fn.ajaxJSSwitch({
		...
		buttonOver:function (item){
			if(MSIE8){
				item.css({"color":"#ff7f66"});
				$(".openPart", item).css({"visibility":"visible"});
			}else{
				item.stop(true).animate({"color":"#ff7f66"}, 200, "easeOutCubic");
		...
		subMenuButtonOut:function (item){
		      item.stop().animate({"color":"#777"}, 300, "easeOutCubic");
        },
		...
		prevPageAnimate:function (page){
              ...
              $("#menu1").stop(true).delay(0).animate({opacity:1, right:0}, 900, "easeInOutCubic");
              $("h1").stop(true).delay(0).animate({marginLeft:0}, 700, "easeInOutCubic");
		...
		backToSplash:function (){
              ...
              $("#menu1").stop(true).delay(200).animate({opacity:0, right:-2000}, 900, "easeInOutCubic");
              $("h1").stop(true).delay(0).animate({marginLeft:759}, 700, "easeInOutCubic");
